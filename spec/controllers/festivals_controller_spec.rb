...
RSpec.describe FestivalsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all festivals as @festivals" do
      ...
      expect(assigns(:festivals)).to eq([festival])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested festival as @festival" do
      festival = Festival.create! valid_attributes
      get :show, params: {id: festival.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested festival as @festival" do
      festival = Festival.create! valid_attributes
      get :edit, params: {id: festival.to_param}, session: valid_session
      expect(assigns(:festival)).to eq(festival)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Festival" do
        expect {
          post :create, params: {festival: valid_attributes}, session: valid_session
        }.to change(Festival, :count).by(1)
      end

      it "assigns a newly created festival as @festival" do
        post :create, params: {festival: valid_attributes}, session: valid_session
        expect(assigns(:festival)).to be_a(Festival)
        expect(assigns(:festival)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved festival as @festival" do
        post :create, params: {festival: invalid_attributes}, session: valid_session
        expect(assigns(:festival)).to be_a_new(Festival)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested festival" do
        festival = Festival.create! valid_attributes
        put :update, params: {id: festival.to_param, festival: new_attributes}, session: valid_session
        festival.reload
      ...
      it "assigns the requested festival as @festival" do
        festival = Festival.create! valid_attributes
        put :update, params: {id: festival.to_param, festival: valid_attributes}, session: valid_session
        expect(assigns(:festival)).to eq(festival)
      end
    ...
    context "with invalid params" do
      it "assigns the festival as @festival" do
        festival = Festival.create! valid_attributes
        put :update, params: {id: festival.to_param, festival: invalid_attributes}, session: valid_session
        expect(assigns(:festival)).to eq(festival)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested festival" do
      festival = Festival.create! valid_attributes
      expect {
        delete :destroy, params: {id: festival.to_param}, session: valid_session
      }.to change(Festival, :count).by(-1)
    end
    ...
    it "redirects to the festivals list" do
      festival = Festival.create! valid_attributes
      delete :destroy, params: {id: festival.to_param}, session: valid_session
      expect(response).to redirect_to(festivals_url)
    end
  end
